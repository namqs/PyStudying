...
texto = (f'Era uma vez uma pessoa chamada { nome1 }. Ela tinha muitos sonhos e queria se mudar para {lugar}. Porém, para alcançar seus objetivos, ela precisaria de ajuda, pois era muito pobre e não sabia por onde começar. Foi aí que conheceu {nome2}, um garoto que possuia muitos sonhos também, porém, estava tão perdido quanto ela. Ela possuia {idadeEla} anos e ele { idadeEle }, ambos residentes de uma pequena cidade do interior de {lugar2}. {nome2} possuia ainda mais problemas, pois, além de nao saber por onde começar, era tremendamente ligado à sua {animal} {nome3}. Ele a ganhou quando tinha 3 aninhos, e adorava {ação1} e {ação2} com ela. Ligados por um sonho, {nome1} e {nome2} juntaram suas coisas e subiram em um(a) {transp} para ir rumo à {lugar3}, a fim de ganhar mais oportunidades para mudar de vida. E claro, {nome3} foi junto. No meio da estrada eles encontraram {nome4},  o fada madrinha do interior mais {adj} de todos! O que será que vem por ai?')
